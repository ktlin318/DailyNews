...
7. Assign exactly one primary topic from the current schema. Use these boundaries for schema version 1.1: `投資理財` covers markets and investment products; `貸款` covers lending, credit, mortgages, and funding-cost developments; `新鮮事` covers notable policy, consumer, travel, and lifestyle news; `AI` covers AI technology, business adoption, policy, and social effects. Add two to five keywords and relevant audiences.
